...
I have prepared a database prototype for this report. The structure of the database is described below.
...
\begin{figure}[h!]
	\centering
  \includegraphics[scale=0.45]{ask.png}
  \caption{Ask Price}
  \label{fig:ask}
\end{figure}
...
\begin{figure}[h!]
	\centering
  \includegraphics[scale=0.45]{bid.png}
  \caption{Bid Price}
  \label{fig:bid}
\end{figure}

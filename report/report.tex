...
\begin{sciabstract}
This document is the Interim Report for the Capstone Project.
\end{sciabstract}
...
But the scope of this project is very wide - I would encourage you to identify a couple of specific aspects and focus in detail on those.

Also, I would expect to see code outlines, cumulative progress report etc in all subsequent submissions (zip them up in a single file and then upload).

Kindly remember that this cannot just be a literature survey project - there has to be a technology implementation angle to it. 


Also please follow the academic reporting guidelines all through as per the templates shared.
